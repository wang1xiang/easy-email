...
const heroList = [
  {
    ...
    payload: {
      ...
      attributes: {
        ...
        'vertical-align': 'top',
        'background-url': IMAGE_LIST.IMAGE_31,
      },
      children: [
        {
          type: 'text',
  ...
  },
  {
    ...
    payload: {
      ...
      attributes: {
        ...
        'vertical-align': 'top',
        'background-url': IMAGE_LIST.IMAGE_33,
  ...
  },
  {
    ...
    payload: {
      ...
      attributes: {
        ...
        padding: '0px 0px 100px 0px',
        'vertical-align': 'top',
        'background-url': IMAGE_LIST.IMAGE_35,
        'padding-bottom': '100px',
      },
      children: [
        {
  ...
  },
  {
    ...
    payload: {
      ...
      attributes: {
        ...
        padding: '100px 0px 100px 0px',
        'vertical-align': 'top',
        'background-url': IMAGE_LIST.IMAGE_38,
      },
      data: {
        value: {
          content:
